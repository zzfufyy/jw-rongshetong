...
public class SecurityFilter implements Filter {
	...
	public void init(FilterConfig arg0) throws ServletException {
		...
		GreenUrlSet.add("/upload");
		GreenUrlSet.add("/imageess");
		GreenUrlSet.add("/jrzd");
		...
		GreenUrlSet.add("/fczc");
		GreenUrlSet.add("/bankcontent");
		GreenUrlSet.add("/yjsq");
		GreenUrlSet.add("/tesejr");
		GreenUrlSet.add("/gywm");
		GreenUrlSet.add("/nsgrb");
		GreenUrlSet.add("/notice");
		GreenUrlSet.add("/mydk");
		GreenUrlSet.add("/qydkrz");
		GreenUrlSet.add("/qyrz");
        GreenUrlSet.add("/jdcx");
        GreenUrlSet.add("/rzdb");
		GreenUrlSet.add("/hzyh");
		GreenUrlSet.add("/.well-known/pki-validation");
		GreenUrlSet.add("/");
		NeedAccountSet.add("/account");
		NeedAccountSet.add("/hbRecharge");
		GreenUrlSet.add("/job-fair");
