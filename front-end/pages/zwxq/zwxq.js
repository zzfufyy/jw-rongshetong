...
Page({
    ...
    onLoad: async function (options) {
        ...
        try {
            ...
            this.setData({
                ...
                jobRequire: string_util.isEmpty(jobData.jobRequire) ? null : jobData.jobRequire,
    ...
    createNewImg: async function () {
        ...
        console.log(path2)
        if (path2 != "../../img/portrait/personal_portrait_male2x.svg" && path2 != "../../img/portrait/personal_portrait_female2x.svg") {
