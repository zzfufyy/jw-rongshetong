...
App({
    globalData: {
        web_path: "https://rst.csjing.com", //线上
    ...
    onLaunch: async function () {
        ...
        // 初次授权录音、视频
        iAuthorizeService.authorizeRecord();
        iAuthorizeService.authorizeCamera();

        // 授权完成
        this.state.appInitCompleter.resolve(true);
        console.info("app init - finish app初始化完成");
    },
    ...
    // 获取系统信息
    _doGetSystemInfo: async function () {
