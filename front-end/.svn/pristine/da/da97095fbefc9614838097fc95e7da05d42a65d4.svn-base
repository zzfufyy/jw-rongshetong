...
const loadEntityById = function (id) {
    return $.request({
        url: '/recruit-record/info?recordId=' + id,
        data: {},
...
const listRecordForCandidatePlus = function (condition) {
    return $.request({
        url: '/recruit-record/listRecordForCandidatePlus',
        data: condition,
        method: $.RequestMethod.POST,
        header: $.jsonHeader
    })
...
const countInterviewResult = function (candidateOpenid) {
    return $.request({
        url: '/recruit-record/countInterviewResult?candidateOpenid=' + candidateOpenid,
        data: {},
        method: $.RequestMethod.GET,
        header: $.jsonHeader
    })
...
module.exports = {
    ...
    listRecordForCandidatePlus: listRecordForCandidatePlus,
    countInterviewResult: countInterviewResult,
}