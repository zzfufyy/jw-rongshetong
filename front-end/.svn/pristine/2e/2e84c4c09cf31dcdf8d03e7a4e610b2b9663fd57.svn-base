...
const loadEntityPlusById = function (openid) {
    return $.request({
        url: '/user-candidate/infoPlus?openid=' + openid,
        data: {},
        method: $.RequestMethod.GET,
        header: $.jsonHeader,
    });
...
const pagedByCondition = function (pagingParam) {
    return $.request({
        url: '/user-candidate/pagedByCondition',
        data: pagingParam,
        method: $.RequestMethod.POST,
        header: $.jsonHeader,
    });
...
const updateByEduInfo = function (pagingParam) {
    return $.request({
        url: '/user-candidate/updateByEduInfo',
        data: pagingParam,
        method: $.RequestMethod.POST,
        header: $.jsonHeader,
    });
...
module.exports = {
    ...
    updateByEduInfo: updateByEduInfo,
}